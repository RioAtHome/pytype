...
def test_check_input_at_empty_string():
    assert Typing("Hello World!").check_input("") is True
...
def test_check_input_adding_correct_input():
    ...
    assert test_component_typing.checking_array[0] is True
...
def test_check_input_adding_wrong_input():
    ...
    assert test_component_typing.checking_array[0] is False
...
def test_check_input_input_then_backspace():
    ...
    assert test_component_typing.typing_start is False
...
def test_check_input_return_false_at_end_of_string():
    ...
    assert test_component_typing.check_input("heLlo!") is False
