		...
		if self.cursor_pointer != len(self.sentence_array) - 1:
			...
			if self.cursor_pointer == 0:
				...
				if self.input_char == self.sentence_array[self.cursor_pointer]:
					...
					self.previous_state.append(('wronginput', self.sentence_string[self.cursor_pointer:self.cursor_pointer+1]))
			...
			# No
				...
				if len(string_typed) >= self.cursor_pointer:
					...
					if self.input_char == self.sentence_array[self.cursor_pointer]:
						self.checking_array.append(True)
						self.previous_state.append(('rightinput', self.sentence_string[self.cursor_pointer:self.cursor_pointer+1]))
